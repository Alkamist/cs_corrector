...
// cs_corrector_destroy :: proc(state: ^Cs_Corrector_Logic) {
...
// cs_corrector_reset :: proc(state: ^Cs_Corrector_Logic) {
//     state.held_key = nil
//     for key in 0 ..< KEY_COUNT {
//         _free_notes(state, key)
...
// cs_corrector_required_latency :: proc(state: ^Cs_Corrector_Logic) -> int {
//     return -min(
//         0,
...
// process_hold_pedal :: proc(state: ^Cs_Corrector_Logic, is_held: bool) {
//     state.hold_pedal_is_held = is_held
// }

// process_note_on :: proc(state: ^Cs_Corrector_Logic, time, key, velocity: int) {
//     delay := 0
...
// process_note_off :: proc(state: ^Cs_Corrector_Logic, time, key, velocity: int) {
...
// extract_note_events :: proc(state: ^Cs_Corrector_Logic, frame_count: int) -> (result: [dynamic]Note_Event) {
...
// _decrease_event_times :: proc(state: ^Cs_Corrector_Logic, frame_count: int) {
//     for key in 0 ..< KEY_COUNT {
//         for note in state.notes[key] {
...
// _fix_note_overlaps :: proc(state: ^Cs_Corrector_Logic) {
//     for key in 0 ..< KEY_COUNT {
...
// _remove_sent_notes :: proc(state: ^Cs_Corrector_Logic) {
//     for key in 0 ..< KEY_COUNT {
...
// _get_sorted_notes :: proc(state: ^Cs_Corrector_Logic, key: int) -> (result: [dynamic]Note) {
...
// _get_sorted_note_events :: proc(state: ^Cs_Corrector_Logic) -> (result: [dynamic]^Note_Event) {
//     for key in 0 ..< KEY_COUNT {
//         for note in state.notes[key] {
...
// _free_notes :: proc(state: ^Cs_Corrector_Logic, key: int) {
//     for note in state.notes[key] {
//         _free_note(note)
//     }
// }